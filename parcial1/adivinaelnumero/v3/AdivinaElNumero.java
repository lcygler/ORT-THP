package parcial1.adivinaelnumero.v3;
...
public class AdivinaElNumero {
    ...
    public static void main(String[] args) {
    	 int ronda = 0, totalRondas, numeroPrograma, numero1, numero2;
        ...
        totalRondas = obtenerRondas();
        
        // Iniciar el juego por cada ronda
        while (ronda < totalRondas && ganador.isEmpty()) {
            numeroPrograma = obtenerNumeroPrograma();
            numero1 = obtenerNumeroJugador(jugador1);
            numero2 = obtenerNumeroJugador(jugador2);
 ...
 // Función para obtener el número ingresado por el jugador
    private static int obtenerNumeroJugador(String jugador) {
        int numero;
